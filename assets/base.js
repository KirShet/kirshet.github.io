...
function renderImage() {
    ...
    newImg.onload = () => {
        ...
        onScreenCTX.drawImage(newImg, 0, 0, onScreenCVS.width, onScreenCVS.height);
    };
    newImg.src = source;
}
...
let s = new Skeleton('assets/fkkH3uL.png',32,32,0.5,0,0)
  ...
  for (let i=0; i<imageData.data.length; i+=4) {
    ...
    switch(true) {
      ...
      case (color === "rgba(255, 255, 255, 255)"):
        //white pixel
        objects.push(new Skeleton('assets/fkkH3uL.png',32,32,0.5,x*40-SCALE*16+20,y*40-SCALE*32+20));
        break;
      default: 
        //transparent pixel
    }
